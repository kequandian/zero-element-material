...
function SearchSelect(_ref) {
  ...
  var _options$title = options.title,
      ...
      _options$echoField = options.echoField,
      echoField = _options$echoField === void 0 ? nameField : _options$echoField,
  ...
  var formData = modelStatus.formData;
  ...
  var formDataValue = formData[echoField];
  ...
  }, v), _react["default"].createElement(_Dialog["default"], {
    fullScreen: true,
    open: open,
